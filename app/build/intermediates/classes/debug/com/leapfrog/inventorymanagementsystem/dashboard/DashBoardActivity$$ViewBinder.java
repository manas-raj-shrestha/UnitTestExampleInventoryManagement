...
public class DashBoardActivity$$ViewBinder<T extends com.leapfrog.inventorymanagementsystem.dashboard.DashBoardActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131492975, "field 'mDrawerLayout'");
    target.mDrawerLayout = finder.castView(view, 2131492975, "field 'mDrawerLayout'");
    view = finder.findRequiredView(source, 2131492969, "field 'toolbar'");
    target.toolbar = finder.castView(view, 2131492969, "field 'toolbar'");
    view = finder.findRequiredView(source, 2131492977, "field 'collapsingToolbarLayout'");
    target.collapsingToolbarLayout = finder.castView(view, 2131492977, "field 'collapsingToolbarLayout'");
    view = finder.findRequiredView(source, 2131492979, "method 'setOnClicks'");
