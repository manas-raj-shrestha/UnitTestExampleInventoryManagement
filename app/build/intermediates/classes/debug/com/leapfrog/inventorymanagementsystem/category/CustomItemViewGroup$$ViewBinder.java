...
public class CustomItemViewGroup$$ViewBinder<T extends com.leapfrog.inventorymanagementsystem.category.CustomItemViewGroup> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131493002, "field 'ivFavIndicator'");
    target.ivFavIndicator = finder.castView(view, 2131493002, "field 'ivFavIndicator'");
    view = finder.findRequiredView(source, 2131493001, "field 'ivFav'");
    target.ivFav = finder.castView(view, 2131493001, "field 'ivFav'");
    view = finder.findRequiredView(source, 2131493000, "field 'tvDealerName'");
    target.tvDealerName = finder.castView(view, 2131493000, "field 'tvDealerName'");
