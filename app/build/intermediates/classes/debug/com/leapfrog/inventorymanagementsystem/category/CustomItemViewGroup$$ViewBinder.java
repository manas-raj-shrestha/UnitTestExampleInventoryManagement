...
public class CustomItemViewGroup$$ViewBinder<T extends com.leapfrog.inventorymanagementsystem.category.CustomItemViewGroup> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131492994, "field 'ivFavIndicator'");
    target.ivFavIndicator = finder.castView(view, 2131492994, "field 'ivFavIndicator'");
    view = finder.findRequiredView(source, 2131492993, "field 'ivFav'");
    target.ivFav = finder.castView(view, 2131492993, "field 'ivFav'");
    view = finder.findRequiredView(source, 2131492992, "field 'tvDealerName'");
    target.tvDealerName = finder.castView(view, 2131492992, "field 'tvDealerName'");
